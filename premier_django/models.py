...
class match_info(models.Model):
    ...
    home_team_possession = models.IntegerField(default=0)
    away_team_possession = models.IntegerField(default=0)
...
class goal(models.Model):
    ...
    def __str__(self):
        return self.player.player_name + ' ' + str(self.goal_type) + ' '
...
class assist(models.Model):
    ...
    def __str__(self):
        return self.player.player_name + ' ' + str(self.player) + ' '
