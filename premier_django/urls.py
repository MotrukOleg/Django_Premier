...
urlpatterns = [
    ...
    path('api/clubs_list/', ClubViewSet.as_view({'get': 'list'})),
    ...
    path('api/players_list/', PlayerViewSet.as_view({'get': 'list'})),
    ...
    path('api/players_delete/<int:pk>/', PlayerViewSet.as_view({'delete': 'destroy'})),

    path('api/matches_list/', MatchViewSet.as_view({'get': 'list'})),
